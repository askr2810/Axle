...
const UI = {
  nb: {
    ...
    tchHomeTheory: (u, lv) => `Neste er «${u}». Jeg anbefaler at du leser teorien før du starter.`, tchHomeNext: (u, lv) => `Klar for ${lv} i «${u}»? Trykk på den blinkende knappen.`,
  ...
  en: {
    ...
    tchHomeTheory: (u, lv) => `Next up is \u201c${u}\u201d. I recommend reading the theory before you start.`, tchHomeNext: (u, lv) => `Ready for ${lv} in \u201c${u}\u201d? Tap the glowing button.`,
