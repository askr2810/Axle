...
const UI = {
  nb: {
    ...
    dcTitle: "Dagens utfordring", dcSub: n => `${n} blandede oppgaver fra fagene dine. Opptil 30 XP!`, dcStart: "Start", dcDone: (a, n) => `Fullført i dag: ${a} av ${n} riktige på første forsøk. Ny utfordring i morgen.`, dcDoneTitle: "Utfordringen er fullført!",
    ...
    qtExam: "Prøveeksamen", qtExamSub: "Test deg som på eksamen", qtReview: "Repeter feil", qtReviewSub: n => `${n} oppgaver`, qtDcSub: "Opptil 30 XP", qtDcDone: (a, n) => `Fullført · ${a}/${n}`,
    ...
    ssXpHow: "Du får XP for hver leksjon: mer for høyere nivå og for hvert riktig svar på første forsøk. Dagens utfordring gir opptil 30 XP.", ssGoal: "Endre dagsmål",
  ...
  en: {
    ...
    dcTitle: "Daily challenge", dcSub: n => `${n} mixed questions from your courses. Up to 30 XP!`, dcStart: "Start", dcDone: (a, n) => `Done today: ${a} of ${n} right on the first try. New challenge tomorrow.`, dcDoneTitle: "Challenge completed!",
    ...
    qtExam: "Practice exam", qtExamSub: "Test yourself exam-style", qtReview: "Review mistakes", qtReviewSub: n => `${n} questions`, qtDcSub: "Up to 30 XP", qtDcDone: (a, n) => `Done · ${a}/${n}`,
    ...
    ssXpHow: "You earn XP for every lesson: more for higher levels and for each answer right on the first try. The daily challenge gives up to 30 XP.", ssGoal: "Change daily goal",
