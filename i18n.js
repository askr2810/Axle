...
const UI = {
  nb: {
    ...
    simTry: "Prøv selv", simQ: "Prøv:", setTheme: "Utseende", theme_auto: "System", theme_light: "Lys", theme_dark: "Mørk", favTitle: "Favoritter", favHint: "Trykk på stjerna for å gjøre et fag til favoritt. Favorittene kommer øverst og som snarveier på forsiden.", favCore: "Grunnbegreper", favCoreSub: "Kort terping som holder det grunnleggende friskt", drCountN: (k, n) => `${k}/${n}`,
  ...
  en: {
    ...
    simTry: "Try it", simQ: "Try:", setTheme: "Appearance", theme_auto: "System", theme_light: "Light", theme_dark: "Dark", favTitle: "Favourites", favHint: "Tap the star to make a course a favourite. Favourites go to the top and appear as shortcuts on the home screen.", favCore: "Core concepts", favCoreSub: "Short drills that keep the basics fresh", drCountN: (k, n) => `${k}/${n}`,
