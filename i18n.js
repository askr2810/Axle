...
const UI = {
  nb: {
    ...
    simTry: "Prøv selv", simQ: "Prøv:", simGoalN: (k, n) => `Oppgave ${k} av ${n}`, simGoalAll: n => `Alle ${n} oppgaver løst`, simGoalOne: "Oppgaven er løst", simGoalAgain: "Prøv oppgavene igjen", simGoalOk: "Løst!", simGoalNext: "Neste oppgave", simGoalFinish: "Ferdig", simGoalHint: "Dra i glidebryterne – svaret sjekkes når du slipper.",
  ...
  en: {
    ...
    simTry: "Try it", simQ: "Try:", simGoalN: (k, n) => `Task ${k} of ${n}`, simGoalAll: n => `All ${n} tasks solved`, simGoalOne: "Task solved", simGoalAgain: "Try the tasks again", simGoalOk: "Solved!", simGoalNext: "Next task", simGoalFinish: "Done", simGoalHint: "Drag the sliders – your answer is checked when you let go.",
